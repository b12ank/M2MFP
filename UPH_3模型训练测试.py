...
train_data_path = r"E:\pycharmproject\raw_code\新工作\UPH全部样本\UPH_train_merge"
test_data_path = r"E:\pycharmproject\raw_code\新工作\UPH全部样本\UPH_test_67"
result_path = r"E:\pycharmproject\raw_code\新工作\UPH全部样本"
...
def train_model(train_data_path):
    ...
    print("Shape of training set:", train_all.shape-1)
    ...
    with open(os.path.join(model_save_path, "UPH全部样本_lightgbm.pkl"), "wb") as f:
        pickle.dump(model, f)
...
def train_and_predict():
    ...
    # model_save_path = result_path
    # with open(os.path.join(model_save_path, "UPH全部样本_lightgbm.pkl"), 'rb') as f:
    #     model = pickle.load(f)
    ...
    submission.to_csv(os.path.join(result_path, "UPH_lightgbm_test67_submission_0.9.csv"), index=False)
