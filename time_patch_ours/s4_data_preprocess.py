...
def get_positive_train_data():
    ...
    feather.write_dataframe(pos_data_all, f'{Config.train_data_path}/positive_train.feather')
...
def get_negative_train_data():
    ...
    feather.write_dataframe(neg_data_all, f'{Config.train_data_path}/negative_train.feather')
...
def get_test_data():
    ...
    feather.write_dataframe(test_data_all, os.path.join(Config.test_data_path, "test_data.feather"))
    print()
