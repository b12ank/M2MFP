...
if __name__ == "__main__":
    ...
    config = Config(
        ...
        time_point_train_data_path=os.path.join(WORK_DIR, "time_patch_train"),
        time_point_test_data_path=os.path.join(WORK_DIR, "time_patch_test"),
        time_patch_train_data_path=os.path.join(WORK_DIR, "time_point_train"),
        time_patch_test_data_path=os.path.join(WORK_DIR, "time_point_test"),
